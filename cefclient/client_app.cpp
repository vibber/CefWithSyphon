...
//syph - this function is added in order to set command line flags
void ClientApp::OnBeforeCommandLineProcessing( const CefString& process_type, CefRefPtr<CefCommandLine> command_line )
{
    //syph - This enables flash (e.g. youtube). It problably slows down complex web pages though. So you could disable it
    //if you don't need flash.
	command_line->AppendSwitch( CefString( "disable-accelerated-compositing" ) );    
}
